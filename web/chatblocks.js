...
Blockly.JavaScript[ "time_current" ] = function(block) {
	var code = `luxon.DateTime.now()`;
	// var code = `moment( Date.now() )`;
	return [code, Blockly.JavaScript.ORDER_NONE];
};
...
Blockly.Blocks[ "timezones_current" ] = {
	init: function() {
		this.jsonInit({
			"type": "timezones_current",
			"message0": "get current timestamp for (major) city %1",
			"args0": [
				{
					"type": "input_value",
					"name": "CITY-NAME",
...
Blockly.JavaScript[ "timezones_current" ] = function(block) {
	var value_cityname = Blockly.JavaScript.valueToCode(block, "CITY-NAME", Blockly.JavaScript.ORDER_ATOMIC) || '';
	var code = `( timezones.find( z => z.toLowerCase().replace( /_/g, " " ).includes( ${value_cityname}.toLowerCase() ) ) ? luxon.DateTime.now().setZone( timezones.find( z => z.toLowerCase().replace( /_/g, " " ).includes( ${value_cityname}.toLowerCase() ) ) ) : null )`;
	return [code, Blockly.JavaScript.ORDER_NONE];
};
...
Blockly.Blocks[ "time_format" ] = {
	init: function() {
		this.jsonInit({
			"type": "time_format",
			"message0": "format timestamp %1 to %2",
			"args0": [
				{
					"type": "input_value",
					"name": "TIMESTAMP",
...
Blockly.JavaScript[ "time_format" ] = function(block) {
	var value_timestamp = Blockly.JavaScript.valueToCode(block, "TIMESTAMP", Blockly.JavaScript.ORDER_ATOMIC) || '';
	var value_timeformat = Blockly.JavaScript.valueToCode(block, "TIMEFORMAT", Blockly.JavaScript.ORDER_ATOMIC) || '"FF"';
	var code = `${value_timestamp}.toFormat( ${value_timeformat} )`;
	return [code, Blockly.JavaScript.ORDER_NONE];
};
...
Blockly.Blocks["math_parseFromText"] = {
	init: function() {
		this.jsonInit({
		"type": "math_parseFromText",
...
Blockly.JavaScript["math_parseFromText"] = function(block) {
	var value_exp = Blockly.JavaScript.valueToCode(block, "EXPRESSION", Blockly.JavaScript.ORDER_ATOMIC);
	var code = `( parseFloat( ${value_exp} ) )`;
	return [code, Blockly.JavaScript.ORDER_NONE];
};
